                    ...
                    <div class="p-5">
                        <figure>
                            @if (isset($post->images[0]))
                                <img class="object-center object-cover w-full h-70"
                                    src="{{ asset('storage/' . $post->images[0]->path) }}" alt="Product Image" />
                            @else
                                <img class="w-full h-70 object-cover"
                                    src="https://media.istockphoto.com/id/1409329028/vector/no-picture-available-placeholder-thumbnail-icon-illustration-design.jpg?s=612x612&w=0&k=20&c=_zOuJu755g2eEUioiOUdz_mHKJQJn-tDgIAhQzyeKUQ="
                                    alt="no Image" />
                            @endif
                        </figure>
                    </div>
                    <div class="card-body space-y-3 max-h-[320px] overflow-hidden">
                        <a href="{{ route('posts.show.view', $post->id) }}">
                            ...
                            <div>
                                <p class="text-base text-gray-600 h-20 overflow-hidden overflow-ellipsis break-words">
