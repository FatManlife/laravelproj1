    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function createPreviewItem(imageSrc) {
                ...
                removeButton.classList.add('absolute', 'top-1', 'right-1', 'text-white', 'bg-red-500',
                    'border-none', 'rounded-md', 'px-1', 'opacity-0', 'group-hover:opacity-100', 'transition');

                const previewImage = document.createElement('img');
                previewImage.src = imageSrc;
                previewImage.classList.add('w-full', 'aspect-square', 'object-center', 'object-contain',
                    'rounded-md', 'mb-2', 'border', 'border-gray-300');
